...
const float SET1_YAW_FEEDBACK_KP = 1.0f;
const float SET1_YAW_FEEDBACK_KI = 0.0f;
const float SET1_YAW_FEEDBACK_INTEGRAL_LIMIT = 0.5f;
const float SET1_YAW_FEEDBACK_MAX_CORRECTION_RAD_S = 1.00f;
const float SET1_YAW_FEEDBACK_MAX_STEP_RAD_S = 0.20f;
...
const uint32_t ENTRY_CLOSE_DELAY_MS = 500;
const int IR_CAPTURE_FORWARD_PWM = 70;
const uint32_t IR_CAPTURE_ADVANCE_TIMEOUT_MS = 3000;
