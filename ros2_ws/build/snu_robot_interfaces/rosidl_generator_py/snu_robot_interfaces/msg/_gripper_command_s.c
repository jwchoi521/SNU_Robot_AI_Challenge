...
bool snu_robot_interfaces__msg__gripper_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("snu_robot_interfaces.msg._gripper_command.GripperCommand", full_classname_dest, 56) == 0);
  }
  snu_robot_interfaces__msg__GripperCommand * ros_message = _ros_message;
  {  // header
...
PyObject * snu_robot_interfaces__msg__gripper_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("snu_robot_interfaces.msg._gripper_command");
