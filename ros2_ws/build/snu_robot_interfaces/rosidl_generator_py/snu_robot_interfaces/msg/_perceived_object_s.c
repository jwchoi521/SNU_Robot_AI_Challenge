...
bool snu_robot_interfaces__msg__perceived_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("snu_robot_interfaces.msg._perceived_object.PerceivedObject", full_classname_dest, 58) == 0);
  }
  snu_robot_interfaces__msg__PerceivedObject * ros_message = _ros_message;
  {  // object_kind
  ...
  {  // navigation_role
    PyObject * field = PyObject_GetAttrString(_pymsg, "navigation_role");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->navigation_role = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // confidence
  ...
  {  // obstacle_radius_m
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_radius_m");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->obstacle_radius_m = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pick_allowed
...
PyObject * snu_robot_interfaces__msg__perceived_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("snu_robot_interfaces.msg._perceived_object");
  ...
  {  // navigation_role
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->navigation_role);
    {
      int rc = PyObject_SetAttrString(_pymessage, "navigation_role", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // obstacle_radius_m
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obstacle_radius_m);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_radius_m", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
