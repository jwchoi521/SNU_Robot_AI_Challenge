...
bool snu_robot_interfaces__msg__four_wheel_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("snu_robot_interfaces.msg._four_wheel_command.FourWheelCommand", full_classname_dest, 61) == 0);
  }
  snu_robot_interfaces__msg__FourWheelCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // command_mode
    ...
    ros_message->command_mode = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // front_left
...
{
  /* NOTE(esteve): Call constructor of FourWheelCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("snu_robot_interfaces.msg._four_wheel_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FourWheelCommand");
  ...
  {  // command_mode
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->command_mode);
    {
