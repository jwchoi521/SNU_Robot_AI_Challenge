...
{
  new (message_memory) snu_robot_interfaces::msg::PerceivedObjectArray(_init);
}

void PerceivedObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<snu_robot_interfaces::msg::PerceivedObjectArray *>(message_memory);
  typed_message->~PerceivedObjectArray();
}

size_t size_function__PerceivedObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<snu_robot_interfaces::msg::PerceivedObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<snu_robot_interfaces::msg::PerceivedObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<snu_robot_interfaces::msg::PerceivedObject> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const snu_robot_interfaces::msg::PerceivedObject *>(
    get_const_function__PerceivedObjectArray__objects(untyped_member, index));
  auto & value = *reinterpret_cast<snu_robot_interfaces::msg::PerceivedObject *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<snu_robot_interfaces::msg::PerceivedObject *>(
    get_function__PerceivedObjectArray__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const snu_robot_interfaces::msg::PerceivedObject *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PerceivedObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(snu_robot_interfaces::msg::PerceivedObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<snu_robot_interfaces::msg::PerceivedObject>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(snu_robot_interfaces::msg::PerceivedObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PerceivedObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(snu_robot_interfaces::msg::PerceivedObjectArray),
...
get_message_type_support_handle<snu_robot_interfaces::msg::PerceivedObjectArray>()
{
  return &::snu_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::PerceivedObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snu_robot_interfaces, msg, PerceivedObjectArray)() {
  return &::snu_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::PerceivedObjectArray_message_type_support_handle;
}
