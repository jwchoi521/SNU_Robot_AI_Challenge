...
#include "snu_robot_interfaces/msg/detail/perceived_object__rosidl_typesupport_fastrtps_c.h"
...
using _PerceivedObject__ros_msg_type = snu_robot_interfaces__msg__PerceivedObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: navigation_role
  {
    cdr << ros_message->navigation_role;
  }
  ...
  // Field name: obstacle_radius_m
  {
    cdr << ros_message->obstacle_radius_m;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name navigation_role
  {
    size_t item_size = sizeof(ros_message->navigation_role);
  ...
  // field.name obstacle_radius_m
  {
    size_t item_size = sizeof(ros_message->obstacle_radius_m);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pick_allowed
...
static uint32_t _PerceivedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_snu_robot_interfaces__msg__PerceivedObject(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snu_robot_interfaces__msg__PerceivedObject;
    is_plain =
      (
...
static size_t _PerceivedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_snu_robot_interfaces__msg__PerceivedObject(
