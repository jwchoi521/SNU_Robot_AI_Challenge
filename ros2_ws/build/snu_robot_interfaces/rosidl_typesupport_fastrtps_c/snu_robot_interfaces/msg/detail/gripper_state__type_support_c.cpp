...
#include "snu_robot_interfaces/msg/detail/gripper_state__rosidl_typesupport_fastrtps_c.h"
...
using _GripperState__ros_msg_type = snu_robot_interfaces__msg__GripperState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: has_object
  {
    cdr << (ros_message->has_object ? true : false);
  }

  // Field name: opening_m
  {
    cdr << ros_message->opening_m;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: has_object
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_object = tmp ? true : false;
  }
...
size_t get_serialized_size_snu_robot_interfaces__msg__GripperState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperState__ros_msg_type * ros_message = static_cast<const _GripperState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name has_object
  {
    size_t item_size = sizeof(ros_message->has_object);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name opening_m
  {
    size_t item_size = sizeof(ros_message->opening_m);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name effort
...
static uint32_t _GripperState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_snu_robot_interfaces__msg__GripperState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_snu_robot_interfaces
size_t max_serialized_size_snu_robot_interfaces__msg__GripperState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snu_robot_interfaces__msg__GripperState;
    is_plain =
      (
...
static size_t _GripperState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_snu_robot_interfaces__msg__GripperState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snu_robot_interfaces, msg, GripperState)() {
