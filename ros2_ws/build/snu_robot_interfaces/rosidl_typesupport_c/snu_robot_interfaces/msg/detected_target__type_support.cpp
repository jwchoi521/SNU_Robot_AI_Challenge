...
static const _DetectedTarget_type_support_symbol_names_t _DetectedTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snu_robot_interfaces, msg, DetectedTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, snu_robot_interfaces, msg, DetectedTarget)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, snu_robot_interfaces, msg, DetectedTarget)() {
  return &::snu_robot_interfaces::msg::rosidl_typesupport_c::DetectedTarget_message_type_support_handle;
}
