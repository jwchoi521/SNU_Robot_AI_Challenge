...
static const _DetectedTarget_type_support_symbol_names_t _DetectedTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snu_robot_interfaces, msg, DetectedTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snu_robot_interfaces, msg, DetectedTarget)),
  }
};
...
{
  return &::snu_robot_interfaces::msg::rosidl_typesupport_cpp::DetectedTarget_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, snu_robot_interfaces, msg, DetectedTarget)() {
  return get_message_type_support_handle<snu_robot_interfaces::msg::DetectedTarget>();
}
