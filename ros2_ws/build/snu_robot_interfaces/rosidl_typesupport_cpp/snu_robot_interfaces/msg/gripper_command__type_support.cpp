...
static const _GripperCommand_type_support_symbol_names_t _GripperCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snu_robot_interfaces, msg, GripperCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snu_robot_interfaces, msg, GripperCommand)),
  }
};
...
{
  return &::snu_robot_interfaces::msg::rosidl_typesupport_cpp::GripperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, snu_robot_interfaces, msg, GripperCommand)() {
  return get_message_type_support_handle<snu_robot_interfaces::msg::GripperCommand>();
}
