...
#include "snu_robot_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const snu_robot_interfaces::msg::GripperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  snu_robot_interfaces::msg::GripperCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snu_robot_interfaces::msg::GripperCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const snu_robot_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<snu_robot_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snu_robot_interfaces, msg, GripperCommand)() {
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
