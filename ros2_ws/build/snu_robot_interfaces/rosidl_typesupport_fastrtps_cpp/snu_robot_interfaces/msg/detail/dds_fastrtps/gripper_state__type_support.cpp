...
#include "snu_robot_interfaces/msg/detail/gripper_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const snu_robot_interfaces::msg::GripperState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  snu_robot_interfaces::msg::GripperState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snu_robot_interfaces::msg::GripperState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const snu_robot_interfaces::msg::GripperState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<snu_robot_interfaces::msg::GripperState *>(
    untyped_ros_message);
...
get_message_type_support_handle<snu_robot_interfaces::msg::GripperState>()
{
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snu_robot_interfaces, msg, GripperState)() {
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
