...
#include "snu_robot_interfaces/msg/detail/perceived_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const snu_robot_interfaces::msg::PerceivedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  snu_robot_interfaces::msg::PerceivedObject & ros_message)
{
  // Member: object_kind
  cdr >> ros_message.object_kind;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snu_robot_interfaces::msg::PerceivedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const snu_robot_interfaces::msg::PerceivedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<snu_robot_interfaces::msg::PerceivedObject *>(
    untyped_ros_message);
...
get_message_type_support_handle<snu_robot_interfaces::msg::PerceivedObject>()
{
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_PerceivedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snu_robot_interfaces, msg, PerceivedObject)() {
  return &snu_robot_interfaces::msg::typesupport_fastrtps_cpp::_PerceivedObject__handle;
}
