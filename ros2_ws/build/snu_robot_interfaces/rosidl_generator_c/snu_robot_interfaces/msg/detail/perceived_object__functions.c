...
snu_robot_interfaces__msg__PerceivedObject__init(snu_robot_interfaces__msg__PerceivedObject * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->object_kind)) {
    snu_robot_interfaces__msg__PerceivedObject__fini(msg);
    return false;
  }
  // fruit_kind
...
snu_robot_interfaces__msg__PerceivedObject__are_equal(const snu_robot_interfaces__msg__PerceivedObject * lhs, const snu_robot_interfaces__msg__PerceivedObject * rhs)
{
  ...
  // navigation_role
  if (lhs->navigation_role != rhs->navigation_role) {
    return false;
  }
  // confidence
  ...
  // obstacle_radius_m
  if (lhs->obstacle_radius_m != rhs->obstacle_radius_m) {
    return false;
  }
  // pick_allowed
  ...
  snu_robot_interfaces__msg__PerceivedObject * output)
{
  ...
  // navigation_role
  output->navigation_role = input->navigation_role;
  // confidence
  ...
  // obstacle_radius_m
  output->obstacle_radius_m = input->obstacle_radius_m;
  // pick_allowed
...
snu_robot_interfaces__msg__PerceivedObject__create()
{
  ...
  snu_robot_interfaces__msg__PerceivedObject * msg = (snu_robot_interfaces__msg__PerceivedObject *)allocator.allocate(sizeof(snu_robot_interfaces__msg__PerceivedObject), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snu_robot_interfaces__msg__PerceivedObject));
  bool success = snu_robot_interfaces__msg__PerceivedObject__init(msg);
  if (!success) {
...
snu_robot_interfaces__msg__PerceivedObject__Sequence__init(snu_robot_interfaces__msg__PerceivedObject__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snu_robot_interfaces__msg__PerceivedObject * data = NULL;

  if (size) {
    data = (snu_robot_interfaces__msg__PerceivedObject *)allocator.zero_allocate(size, sizeof(snu_robot_interfaces__msg__PerceivedObject), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snu_robot_interfaces__msg__PerceivedObject__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        snu_robot_interfaces__msg__PerceivedObject__fini(&data[i - 1]);
      }
...
snu_robot_interfaces__msg__PerceivedObject__Sequence__fini(snu_robot_interfaces__msg__PerceivedObject__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      snu_robot_interfaces__msg__PerceivedObject__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snu_robot_interfaces__msg__PerceivedObject__Sequence * array = (snu_robot_interfaces__msg__PerceivedObject__Sequence *)allocator.allocate(sizeof(snu_robot_interfaces__msg__PerceivedObject__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snu_robot_interfaces__msg__PerceivedObject__Sequence__init(array, size);
  if (!success) {
...
snu_robot_interfaces__msg__PerceivedObject__Sequence__destroy(snu_robot_interfaces__msg__PerceivedObject__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snu_robot_interfaces__msg__PerceivedObject__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snu_robot_interfaces__msg__PerceivedObject__Sequence__are_equal(const snu_robot_interfaces__msg__PerceivedObject__Sequence * lhs, const snu_robot_interfaces__msg__PerceivedObject__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snu_robot_interfaces__msg__PerceivedObject__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snu_robot_interfaces__msg__PerceivedObject__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snu_robot_interfaces__msg__PerceivedObject);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snu_robot_interfaces__msg__PerceivedObject * data =
      (snu_robot_interfaces__msg__PerceivedObject *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snu_robot_interfaces__msg__PerceivedObject__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snu_robot_interfaces__msg__PerceivedObject__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!snu_robot_interfaces__msg__PerceivedObject__copy(
