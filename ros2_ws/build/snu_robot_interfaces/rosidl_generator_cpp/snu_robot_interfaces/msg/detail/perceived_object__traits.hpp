...
#ifndef SNU_ROBOT_INTERFACES__MSG__DETAIL__PERCEIVED_OBJECT__TRAITS_HPP_
#define SNU_ROBOT_INTERFACES__MSG__DETAIL__PERCEIVED_OBJECT__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: navigation_role
  {
    out << "navigation_role: ";
    rosidl_generator_traits::value_to_yaml(msg.navigation_role, out);
    out << ", ";
  }
  ...
  // member: obstacle_radius_m
  {
    out << "obstacle_radius_m: ";
    rosidl_generator_traits::value_to_yaml(msg.obstacle_radius_m, out);
    out << ", ";
  }
...
inline void to_yaml(
  const snu_robot_interfaces::msg::PerceivedObject & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const snu_robot_interfaces::msg::PerceivedObject & msg)
{
  return snu_robot_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<snu_robot_interfaces::msg::PerceivedObject>()
{
  return "snu_robot_interfaces::msg::PerceivedObject";
}

template<>
inline const char * name<snu_robot_interfaces::msg::PerceivedObject>()
{
  return "snu_robot_interfaces/msg/PerceivedObject";
}

template<>
struct has_fixed_size<snu_robot_interfaces::msg::PerceivedObject>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<snu_robot_interfaces::msg::PerceivedObject>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<snu_robot_interfaces::msg::PerceivedObject>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SNU_ROBOT_INTERFACES__MSG__DETAIL__PERCEIVED_OBJECT__TRAITS_HPP_
