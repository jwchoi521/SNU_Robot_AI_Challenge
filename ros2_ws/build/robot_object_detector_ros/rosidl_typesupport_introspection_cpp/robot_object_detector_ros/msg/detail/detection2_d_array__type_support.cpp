...
{
  new (message_memory) robot_object_detector_ros::msg::Detection2DArray(_init);
}

void Detection2DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_object_detector_ros::msg::Detection2DArray *>(message_memory);
  typed_message->~Detection2DArray();
}

size_t size_function__Detection2DArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<robot_object_detector_ros::msg::Detection2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robot_object_detector_ros::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robot_object_detector_ros::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const robot_object_detector_ros::msg::Detection2D *>(
    get_const_function__Detection2DArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<robot_object_detector_ros::msg::Detection2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<robot_object_detector_ros::msg::Detection2D *>(
    get_function__Detection2DArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const robot_object_detector_ros::msg::Detection2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection2DArray_message_member_array[2] = {
  {
    ...
    offsetof(robot_object_detector_ros::msg::Detection2DArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_object_detector_ros::msg::Detection2DArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection2DArray_message_members = {
  ...
  2,  // number of fields
  sizeof(robot_object_detector_ros::msg::Detection2DArray),
...
get_message_type_support_handle<robot_object_detector_ros::msg::Detection2DArray>()
{
  return &::robot_object_detector_ros::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_object_detector_ros, msg, Detection2DArray)() {
  return &::robot_object_detector_ros::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
