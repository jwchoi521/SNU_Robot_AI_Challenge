...
#include "robot_object_detector_ros/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_object_detector_ros::msg::Detection2DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_object_detector_ros::msg::Detection2DArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_object_detector_ros::msg::Detection2DArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_object_detector_ros::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_object_detector_ros::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  return &robot_object_detector_ros::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_object_detector_ros, msg, Detection2DArray)() {
  return &robot_object_detector_ros::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
