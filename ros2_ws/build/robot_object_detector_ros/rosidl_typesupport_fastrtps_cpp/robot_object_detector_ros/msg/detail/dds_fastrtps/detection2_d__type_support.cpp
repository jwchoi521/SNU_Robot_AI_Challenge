...
#include "robot_object_detector_ros/msg/detail/detection2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_object_detector_ros::msg::Detection2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_object_detector_ros::msg::Detection2D & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_object_detector_ros::msg::Detection2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_object_detector_ros::msg::Detection2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_object_detector_ros::msg::Detection2D *>(
    untyped_ros_message);
...
{
  return &robot_object_detector_ros::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_object_detector_ros, msg, Detection2D)() {
  return &robot_object_detector_ros::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
