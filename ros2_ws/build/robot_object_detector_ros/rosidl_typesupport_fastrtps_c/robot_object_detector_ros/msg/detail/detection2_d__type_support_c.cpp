...
#include "robot_object_detector_ros/msg/detail/detection2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Detection2D__ros_msg_type = robot_object_detector_ros__msg__Detection2D;
...
static uint32_t _Detection2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_object_detector_ros__msg__Detection2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_object_detector_ros__msg__Detection2D;
    is_plain =
      (
...
static size_t _Detection2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_object_detector_ros__msg__Detection2D(
