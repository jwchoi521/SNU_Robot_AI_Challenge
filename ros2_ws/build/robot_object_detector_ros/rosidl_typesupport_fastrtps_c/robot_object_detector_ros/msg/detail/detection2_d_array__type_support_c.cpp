...
#include "robot_object_detector_ros/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "robot_object_detector_ros/msg/detail/detection2_d__functions.h"  // detections
...
using _Detection2DArray__ros_msg_type = robot_object_detector_ros__msg__Detection2DArray;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      robot_object_detector_ros__msg__Detection2D__Sequence__fini(&ros_message->detections);
    }
...
size_t get_serialized_size_robot_object_detector_ros__msg__Detection2DArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection2DArray__ros_msg_type * ros_message = static_cast<const _Detection2DArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Detection2DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_object_detector_ros__msg__Detection2DArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_object_detector_ros
size_t max_serialized_size_robot_object_detector_ros__msg__Detection2DArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_object_detector_ros__msg__Detection2DArray;
    is_plain =
      (
...
static size_t _Detection2DArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_object_detector_ros__msg__Detection2DArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_object_detector_ros, msg, Detection2DArray)() {
