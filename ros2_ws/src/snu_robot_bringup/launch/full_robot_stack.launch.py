...
def generate_launch_description():
    ...
    nav_arguments = {
        ...
        "object_role_confirm_frames": LaunchConfiguration(
        ...
        "bbox_goal_target_switch_min_improvement_m": LaunchConfiguration(
            "bbox_goal_target_switch_min_improvement_m"
        ),
        ...
        "bbox_goal_capture_wait_timeout_sec": LaunchConfiguration(
    ...
    esp32_arguments = {
        ...
        "reset_on_open": LaunchConfiguration("esp32_reset_on_open"),
        "reset_pulse_sec": LaunchConfiguration("esp32_reset_pulse_sec"),
        ...
        "log_pwm_status": LaunchConfiguration("esp32_log_pwm_status"),
        "gripper_command_topic": LaunchConfiguration("gripper_command_topic"),
        "capture_arm_topic": LaunchConfiguration("capture_arm_topic"),
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("esp32_log_pwm_status", default_value="false"),
